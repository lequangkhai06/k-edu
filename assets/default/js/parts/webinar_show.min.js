(function ($) {
  ...
  $("body").on("click", "#webinarDemoVideoBtn", function (e) {
    ...
    var _makeVideoPlayerHtml = makeVideoPlayerHtml(
        path,
        source,
        height,
        videoTagId
  ...
  $("body").on("change", 'input[name="ticket_id"]', function (e) {
    ...
    realPrice
      ...
      .addClass("d-block font-20 text-gray text-decoration-line-through mr-15");
  ...
  $("body").on("click", ".js-play-video", function (e) {
    ...
    handleVideoByFileId(file_id, $modalVideoContent, function () {
      ...
      $modal
        .find('.modal-video-item[data-id="' + file_id + '"]')
        .addClass("active");
  ...
  function showWaitlistModal(webinarSlug, isLogin) {
    var html =
      ...
      "            </div>\n" +
      '            <p class="font-14 font-weight-500 mt-15 text-gray">' +
    ...
    if (!isLogin) {
      html +=
        ...
        "            </div>\n" +
        '           <div class="form-group mb-10">\n' +
        '                <label class="input-label font-weight-500">' +
        captchaLang +
        "</label>\n" +
    ...
    html +=
      ...
      '            <button type="button" class="js-save-waitlist btn btn-primary btn-sm">' +
      joinLang +
      "</button>\n" +
      "        </div>\n" +
      "    </div>";
    ...
    $.post(path, data, function (result) {
      if (result && result.code === 200) {
        ...
        Swal.fire({
          icon: "success",
          html:
            '<h3 class="font-16 text-center text-dark-blue py-25">' +
            result.msg +
            "</h3>",
          showConfirmButton: false,
          width: "25rem",
